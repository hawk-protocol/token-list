import hawkswapList from "../hawkswap.token-list.json";
import hawkswapExperimentalList from "../hawkswap-experimental.token-list.json";
...
export const defaultList: TokenList = hawkswapList;
export const experimental: TokenList = hawkswapExperimentalList;
